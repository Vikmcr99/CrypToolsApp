package com.example.sheettraining.Api
...
interface Endpoint {
    ...
    fun getCurrencyCoin(@Path(value = "from", encoded = true) from : String, @Path(value = "to", encoded = true) to : String) : Call<JsonObject>
}